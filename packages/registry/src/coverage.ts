...
export const CCTP_TESTNET_DIRECTORY: CctpDirectoryEntry[] = [
  ...
  { name: "Linea Sepolia", domain: 11, vm: "EVM", chainId: CHAIN_IDS.LINEA_SEPOLIA, chainIdConfidence: V, keywords: ["linea sepolia"], fastTransfer: true },
  { name: "Codex Testnet", domain: 12, vm: "EVM", chainId: 6513784, chainIdConfidence: A, keywords: ["codex"], fastTransfer: true, note: "no public RPC" },
  { name: "Sonic Testnet", domain: 13, vm: "EVM", chainId: CHAIN_IDS.SONIC_TESTNET, chainIdConfidence: V, keywords: ["sonic testnet"] },
  ...
  { name: "Sei Testnet", domain: 16, vm: "EVM", chainId: CHAIN_IDS.SEI_TESTNET, chainIdConfidence: V, keywords: ["sei testnet"] },
  { name: "BNB Smart Chain Testnet", domain: 17, vm: "EVM", chainId: 97, chainIdConfidence: A, keywords: ["bnb", "test"], note: "USYC only" },
  { name: "XDC Apothem", domain: 18, vm: "EVM", chainId: 51, chainIdConfidence: A, keywords: ["apothem"], note: "no Multicall3" },
  { name: "HyperEVM Testnet", domain: 19, vm: "EVM", chainId: 998, chainIdConfidence: A, keywords: ["hyperliquid", "test"], note: "public RPC unreachable at snapshot" },
  { name: "Ink Sepolia", domain: 21, vm: "EVM", chainId: CHAIN_IDS.INK_SEPOLIA, chainIdConfidence: V, keywords: ["ink sepolia"], fastTransfer: true },
  { name: "Plume Testnet", domain: 22, vm: "EVM", chainId: CHAIN_IDS.PLUME_TESTNET, chainIdConfidence: V, keywords: ["plume testnet"], fastTransfer: true },
  ...
  { name: "Injective Testnet", domain: 29, vm: "EVM", chainId: CHAIN_IDS.INJECTIVE_TESTNET, chainIdConfidence: V, keywords: ["injective testnet"] },
  { name: "Morph Hoodi", domain: 30, vm: "EVM", chainId: 2810, chainIdConfidence: A, keywords: ["morph", "hoodi"], fastTransfer: true, note: "public RPC unreachable at snapshot" },
  { name: "Pharos Testnet", domain: 31, vm: "EVM", chainIdConfidence: A, keywords: ["pharos", "test"] },
  { name: "Cronos Testnet", domain: 32, vm: "EVM", chainId: CHAIN_IDS.CRONOS_TESTNET, chainIdConfidence: V, keywords: ["cronos testnet"] },
  { name: "Plasma Testnet", domain: 33, vm: "EVM", chainId: CHAIN_IDS.PLASMA_TESTNET, chainIdConfidence: V, keywords: ["plasma testnet"] },
  { name: "X Layer Testnet", domain: 37, vm: "EVM", chainId: CHAIN_IDS.XLAYER_TESTNET, chainIdConfidence: V, keywords: ["x layer testnet"], fastTransfer: true },
];
